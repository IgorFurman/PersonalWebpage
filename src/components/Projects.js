...
const largeProjects = [
	{
		...
		description: 'Big Cloud - VapeShop is a robust, feature-rich e-commerce application developed with React.js. It offers an intuitive user experience, complete with product viewing, sorting, and filtering capabilities, alongside an integrated cart system and robust profile management features.',
...
const smallProjects = [
	...
	},
	{
		...
		description: 'Wallet is a personal finance tool. It allows for adding income and expense transactions, viewing a list of them, and calculating the balance. Features include deleting individual or all transactions and theme switching between light and dark.',
		technologies: 'JavaScript, Css',
		link: '',
	},
	{
		name: 'ToDo List App',
		description: 'This project is a simple ToDo List application. The app provides an interface for adding, editing, and removing tasks. The tasks are stored in the browser\'s local storage.',
...
const Projects = () => {
  return (
    <section className='section my-auto mx-auto mt-1 ' id='projects'>
      <div className='container mx-auto h-fit-content'>
			<h2 className='h2 text-accent mt-5'>Projects completed so far</h2>
...
const ProjectCard = ({ name, description, technologies, link }) => (
  <div className='flex flex-col space-y-6'>
    <div>
      ...
      <p className='font-secondary leading-tight mt-2' style={{ textIndent: "2em" }}>
        {description}
      </p>
    ...
    <div className='flex flex-col items-end'>
      ...
      <a href={link} className='text-gradient text-sm mb-1'>
